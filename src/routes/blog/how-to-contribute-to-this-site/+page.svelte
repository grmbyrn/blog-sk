...
<Post title={meta.title} slug={meta.slug} image={meta.image} date={meta.date} tags={meta.tags} excerpt={meta.excerpt} contributor={meta.contributor} contributorSlug={meta.contributorSlug}>
    <Toc class='toc' />
    <div id="toc-contents">
